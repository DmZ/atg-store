 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/MobileCommerce/version/10.2.1/server/MobileCommerce/src/atg/projects/store/mobile/MobileStoreGiftlistFormHandler.java#2 $
 * @updated $DateTime: 2013/03/14 09:38:35 $$Author: jsiddaga $
 */
public class MobileStoreGiftlistFormHandler extends StoreGiftlistFormHandler
{
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/MobileCommerce/version/10.2.1/server/MobileCommerce/src/atg/projects/store/mobile/MobileStoreGiftlistFormHandler.java#2 $$Change: 796863 $";
