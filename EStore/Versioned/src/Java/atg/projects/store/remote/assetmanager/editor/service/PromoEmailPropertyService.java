 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/Versioned/src/atg/projects/store/remote/assetmanager/editor/service/PromoEmailPropertyService.java#4 $Change: 630322 $
 * @updated $DateTime: 2013/03/20 09:35:21 $Author: ykostene $
 *
 */
public class PromoEmailPropertyService extends RepositoryAssetPropertyServiceImpl{
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/Versioned/src/atg/projects/store/remote/assetmanager/editor/service/PromoEmailPropertyService.java#4 $Change: 630322 $";
