 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/collections/filter/ItemValidatorFilter.java#3 $Change: 630322 $
 * @updated $DateTime: 2013/03/11 11:31:02 $Author: ykostene $
 *
 */
public class ItemValidatorFilter extends ValidatorFilter implements ItemFilter {
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/collections/filter/ItemValidatorFilter.java#3 $Change: 630322 $";
