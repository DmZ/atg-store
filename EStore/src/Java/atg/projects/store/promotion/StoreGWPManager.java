 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/promotion/StoreGWPManager.java#3 $$Change: 796506 $
 * @updated $DateTime: 2013/03/13 07:20:39 $$Author: ckearney $
 */
public class StoreGWPManager extends GWPManager {

  //-------------------------------------
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/promotion/StoreGWPManager.java#3 $$Change: 796506 $";
