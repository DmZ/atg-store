...
public class PriceSorter extends GenericService implements PropertySorter{
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/sort/PriceSorter.java#2 $$Change: 788983 $";
