 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StorePropertyNameConstants.java#3 $
 * @updated $DateTime: 2013/03/13 13:26:32 $$Author: ckearney $
 */
public class StorePropertyNameConstants {
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StorePropertyNameConstants.java#3 $$Change: 796635 $";
