 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/ShippingInfoFormHandler.java#3 $$Change: 789218 $ 
 * @updated $DateTime: 2013/02/08 10:59:27 $$Author: jsiddaga $
 */
public class ShippingInfoFormHandler extends ShippingGroupFormHandler {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/ShippingInfoFormHandler.java#3 $$Change: 789218 $";
