 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreBillingProcessHelper.java#5 $$Change: 796011 $ 
 * @updated $DateTime: 2013/03/11 11:57:32 $$Author: ckearney $
 */
public class StoreBillingProcessHelper extends StorePurchaseProcessHelper {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreBillingProcessHelper.java#5 $$Change: 796011 $";
