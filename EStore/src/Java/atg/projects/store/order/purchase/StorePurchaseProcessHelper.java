 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessHelper.java#3 $$Change: 791692 $
 * @updated $DateTime: 2013/02/20 09:37:24 $$Author: jsiddaga $
  */
public class StorePurchaseProcessHelper extends PurchaseProcessHelper {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessHelper.java#3 $$Change: 791692 $";
