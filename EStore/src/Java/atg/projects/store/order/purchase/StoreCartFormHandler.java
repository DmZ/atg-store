 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreCartFormHandler.java#4 $$Change: 796022 $ 
 * @updated $DateTime: 2013/03/11 12:11:24 $$Author: ckearney $
 */
public class StoreCartFormHandler extends CartModifierFormHandler {
    
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreCartFormHandler.java#4 $$Change: 796022 $";
