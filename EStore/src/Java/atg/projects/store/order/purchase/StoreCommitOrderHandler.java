 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreCommitOrderHandler.java#4 $$Change: 796551 $ 
 * @updated $DateTime: 2013/03/13 09:14:59 $$Author: jsiddaga $
 */
public class StoreCommitOrderHandler extends CommitOrderFormHandler {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/purchase/StoreCommitOrderHandler.java#4 $$Change: 796551 $";
