 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreCommerceItemManager.java#2 $
 * @updated $DateTime: 2013/02/07 14:16:38 $$Author: jsiddaga $
 */
public class StoreCommerceItemManager extends CommerceItemManager {
  
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreCommerceItemManager.java#2 $$Change: 788983 $";
