 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#3 $$Change: 794791 $
 * @updated $DateTime: 2013/03/05 10:44:38 $$Author: ckearney $
 */
public class ProcValidateInventoryForCheckout extends ApplicationLoggingImpl implements PipelineProcessor {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#3 $$Change: 794791 $";
