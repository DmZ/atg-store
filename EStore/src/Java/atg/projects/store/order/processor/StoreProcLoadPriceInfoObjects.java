 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/StoreProcLoadPriceInfoObjects.java#3 $$Change: 796535 $
 * @updated $DateTime: 2013/03/13 08:30:25 $$Author: ckearney $
 */
public class StoreProcLoadPriceInfoObjects extends ProcLoadPriceInfoObjects {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/StoreProcLoadPriceInfoObjects.java#3 $$Change: 796535 $";
