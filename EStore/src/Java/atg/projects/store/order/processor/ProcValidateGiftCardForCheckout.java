 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/ProcValidateGiftCardForCheckout.java#3 $$Change: 794837 $
 * @updated $DateTime: 2013/03/05 12:26:39 $$Author: ckearney $
 */
public class ProcValidateGiftCardForCheckout extends ApplicationLoggingImpl implements PipelineProcessor {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/processor/ProcValidateGiftCardForCheckout.java#3 $$Change: 794837 $";
