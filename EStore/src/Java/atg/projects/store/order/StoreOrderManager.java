 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreOrderManager.java#3 $
 * @updated $DateTime: 2013/06/12 05:50:18 $$Author: ckearney $
 */
public class StoreOrderManager extends SimpleOrderManager {
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreOrderManager.java#3 $$Change: 814532 $";
