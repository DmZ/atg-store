 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreOrderTools.java#5 $
 * @updated $DateTime: 2013/03/11 11:53:53 $$Author: ckearney $
 */
public class StoreOrderTools extends OrderTools {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StoreOrderTools.java#5 $$Change: 796009 $";
