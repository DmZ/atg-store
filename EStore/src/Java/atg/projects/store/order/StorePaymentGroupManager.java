 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StorePaymentGroupManager.java#3 $
 * @updated $DateTime: 2013/03/13 11:44:21 $$Author: ckearney $
 * 
 */
public class StorePaymentGroupManager extends PaymentGroupManager {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/order/StorePaymentGroupManager.java#3 $$Change: 796618 $";
