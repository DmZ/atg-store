 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/inventory/StoreInventoryManager.java#6 $
 * @updated $DateTime: 2013/06/13 15:06:53 $$Author: mjanulaw $
 */
public class StoreInventoryManager extends RepositoryInventoryManager {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/inventory/StoreInventoryManager.java#6 $$Change: 814988 $";
  ...
  public Date getBackorderAvailabilityDate(String pSkuId) throws InventoryException {
    return getBackorderAvailabilityDate(pSkuId, null);
  }
  
  public Date getBackorderAvailabilityDate(String pSkuId, String pLocationId) throws InventoryException {
    if (isLoggingDebug()) {
