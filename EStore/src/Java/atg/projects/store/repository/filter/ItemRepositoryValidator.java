...
public class ItemRepositoryValidator extends GenericService implements CollectionObjectValidator {
   ...
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/repository/filter/ItemRepositoryValidator.java#2 $$Change: 788983 $";
