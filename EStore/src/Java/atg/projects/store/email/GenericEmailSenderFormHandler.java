 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/email/GenericEmailSenderFormHandler.java#3 $$Change: 799002 $
 * @updated $DateTime: 2013/03/25 04:45:55 $$Author: ykostene $
 */
public class GenericEmailSenderFormHandler extends GenericFormHandler {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/email/GenericEmailSenderFormHandler.java#3 $$Change: 799002 $";
