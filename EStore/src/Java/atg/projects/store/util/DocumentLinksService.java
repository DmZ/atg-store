 ...
 *  
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/util/DocumentLinksService.java#3 $$Change: 799473 $
 * @updated $DateTime: 2013/03/26 13:23:48 $$Author: ckearney $
 */ 
public class DocumentLinksService extends GenericService {  
  
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/util/DocumentLinksService.java#3 $$Change: 799473 $";
