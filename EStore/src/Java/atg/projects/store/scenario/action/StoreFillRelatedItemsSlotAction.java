 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotAction.java#2 $$Change: 788983 $ 
...
public class StoreFillRelatedItemsSlotAction extends FillRelatedItemsSlotAction {
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotAction.java#2 $$Change: 788983 $";
