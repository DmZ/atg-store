 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/International/src/atg/projects/store/droplet/InternationalizedExpressCheckoutOkDroplet.java#2 $$Change: 788983 $
...
public class InternationalizedExpressCheckoutOkDroplet extends ExpressCheckoutOkDroplet {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/EStore/International/src/atg/projects/store/droplet/InternationalizedExpressCheckoutOkDroplet.java#2 $$Change: 788983 $";
