 ...
 * 
 * @author vbreida
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/MediaBannerHandler.java#3 $$Change: 798755 $
 * @updated $DateTime: 2013/03/22 08:15:10 $$Author: dstewart $
 */
    ...
    try {
      ...
      if (linkBuilder != null) {
        mediaBanner.setLink(linkBuilder.createAction(
          getNavigationStateBuilder(), contentSource, getActionPathProvider()));
      }
    }
