 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/listener/StorePositionMarkingSensorListener.java#3 $$Change: 797662 $ 
 * @updated $DateTime: 2013/03/19 06:46:42 $$Author: ckearney $
 */
public class StorePositionMarkingSensorListener extends PositionMarkingSensorListener {
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/listener/StorePositionMarkingSensorListener.java#3 $$Change: 797662 $";
