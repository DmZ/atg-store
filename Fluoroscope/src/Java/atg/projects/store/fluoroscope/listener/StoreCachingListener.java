 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/listener/StoreCachingListener.java#2 $$Change: 788983 $ 
 * @updated $DateTime: 2013/02/07 14:16:38 $$Author: jsiddaga $
 */
public class StoreCachingListener extends CachingListener {
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/listener/StoreCachingListener.java#2 $$Change: 788983 $";
