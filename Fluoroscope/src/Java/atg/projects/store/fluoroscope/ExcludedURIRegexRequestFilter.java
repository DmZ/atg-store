 ...
 * @see RequestFilter
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/ExcludedURIRegexRequestFilter.java#2 $$Change: 788983 $ 
 * @updated $DateTime: 2013/02/07 14:16:38 $$Author: jsiddaga $
 */
public class ExcludedURIRegexRequestFilter implements RequestFilter {
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Fluoroscope/src/atg/projects/store/fluoroscope/ExcludedURIRegexRequestFilter.java#2 $$Change: 788983 $";
