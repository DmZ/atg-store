 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Recommendations/src/atg/projects/store/recommendations/processor/SetSearchTermProcessor.java#3 $Change: 630322 $
 * @updated $DateTime: 2013/03/19 08:04:50 $Author: ykostene $
 *
 */
public class SetSearchTermProcessor extends PatternMappingProcessor{
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Recommendations/src/atg/projects/store/recommendations/processor/SetSearchTermProcessor.java#3 $Change: 630322 $";
