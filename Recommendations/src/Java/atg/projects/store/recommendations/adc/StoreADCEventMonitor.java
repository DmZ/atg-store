 ...
 *   
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Recommendations/src/atg/projects/store/recommendations/adc/StoreADCEventMonitor.java#2 $Change: 630322 $
 * @updated $DateTime: 2013/02/07 14:16:38 $Author: ykostene $
 *
 */
public class StoreADCEventMonitor extends ADCEventMonitor {
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Recommendations/src/atg/projects/store/recommendations/adc/StoreADCEventMonitor.java#2 $Change: 630322 $";
