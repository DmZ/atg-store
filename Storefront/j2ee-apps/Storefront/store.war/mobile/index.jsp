<%--
  ...
  NOTES:
    1) The "mobileStorePrefix", "siteContextPath", "isLoggedIn", "userGender" request-scoped variables (request attributes),
...
--%>
<dsp:page>
  <fmt:message key="mobile.homepage.title" var="pageTitle"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Storefront/j2ee/store.war/mobile/index.jsp#3 $$Change: 800951 $ --%>
