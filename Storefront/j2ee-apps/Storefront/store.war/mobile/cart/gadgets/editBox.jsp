    ...
    <c:if test="${not empty productUrl}">
      <dsp:a href="javascript:void(0);" iclass="productDetailPageLink">
        ...
        <span class="qty">
          ...
          <abbr title="${quantityAbbrExpansion}"><fmt:message key="mobile.cart.label.quantity"/></abbr>
        </span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Storefront/j2ee/store.war/mobile/cart/gadgets/editBox.jsp#3 $$Change: 789440 $--%>
