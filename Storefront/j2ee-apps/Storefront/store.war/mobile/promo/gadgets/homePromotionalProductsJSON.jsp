<%--
  Return promotional products details JSON from the targeter.
  This page is also called in the "home.js" script.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Storefront/j2ee/store.war/mobile/promo/gadgets/homePromotionalProductsJSON.jsp#2 $$Change: 807101 $--%>
