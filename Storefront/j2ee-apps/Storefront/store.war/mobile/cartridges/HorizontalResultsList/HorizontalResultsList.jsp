  ...
  <div class="horizontalResultsList">
    ...
    <c:if test="${not empty firstRecordNum && firstRecordNum != 1}">
      <div class="navigation leftArrow">
        ...
        <a href="${url}" role="button" title="<fmt:message key='mobile.horizontalResultList.a11y.prev'/>"><img src="/crsdocroot/content/mobile/images/icon-blp-resultsList-previousArrow.png"/></a>
      </div>
    </c:if>
    ...
    <c:if test="${lastRecordNum < totalNumRecords}">
      <div class="navigation rightArrow">
        ...
        <a href="${url}" role="button" title="<fmt:message key='mobile.horizontalResultList.a11y.next'/>"><img src="/crsdocroot/content/mobile/images/icon-blp-resultsList-nextArrow.png"/></a>
      </div>
    </c:if>
  </div>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Storefront/j2ee/store.war/mobile/cartridges/HorizontalResultsList/HorizontalResultsList.jsp#14 $$Change: 801832 $--%>
