    ...
    <dsp:oparam name="outputStart">
      ...
      <c:if test="${productListSize > 1}">
        ...
        <li class="sortToolbar">
          <div id="topPicksSort" class="${topPicksSelected}">${topPicksLabel}</div>
          <div id="nameSort" class="${nameSelected}">${nameSortLabel}</div>
          <div id="priceSort" class="${priceSelected}">${priceSortLabel}</div>
        </li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2.1/Storefront/j2ee/store.war/mobile/browse/gadgets/categoryChildProductsRenderer.jsp#10 $$Change: 805136 $--%>
