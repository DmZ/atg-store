...
CRSMA.home = function() {
  ...
  var EventManager = {
     ...
     *  event name.
     * @param params 
     *  parameters to pass along to the event handler.
     *  
     * @public
     */
   ...
   *
   * @param {object} pItem
   *  Product item, from "Recommendations".
   *  
   * @return {string} 
   *  Formatted price.
   *  
   ...
   * @param {string} pHtml
   *  Product info html.
   * @param {boolean} pDoubleRearPadding
   *  Flag to apply double padding.
   *  
   * @return {string} 
   *  Product info html, with paddings.
   *  
   * @private
   */
   ...
   *
   * @param pProductsArray
   *  Array of product details (JSON).
          ...
          value: function(/*int*/pLeft) {
            if (pLeft <= 0) {
              ...
              if (typeof this.currentCenterCell === "undefined") {
                ...
                EventManager.publish("sliderMoveEvent", {"caller": "promo", "focusedCellIndex": currentCell});
                return;
              };
   ...
   *
   * @param {string} pTargeter
   *  Targeter name which products should be displayed.
   * 
   * @private
   */
          ...
          postTouchMove: {
            value: function(/*int*/pLeft) {
              if (pLeft <= 0) {
                ...
                EventManager.publish("sliderMoveEvent", {"caller": "product", "focusedCellIndex": currentCell});
              }
            }
          }
        } //END of extension
   ...
   * <p>
   * <b>NOTE:</b>
   *   This function also calls "CRSMA.common.hideLoadingWindow" because:
   *   <ol>
